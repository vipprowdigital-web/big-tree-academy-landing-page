...
export default function AboutAcademy({ onCourseClick }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`max-w-4xl mx-auto text-center px-6 sm:pt-16 pb-12 transition-all duration-1000 ease-out ${
          sectionInView
      ...
      >
        <div className="relative flex items-center justify-center">
          ...
          <div className="absolute -top-4 left-0 lg:-left-14 w-12 h-12 border-t-2 border-l-2 border-primary/20 rounded-tl-xl pointer-events-none" />
          <div className="absolute -bottom-4 right-0 lg:-right-14 w-12 h-12 border-b-2 border-r-2 border-primary/20 rounded-br-xl pointer-events-none" />
        </div>

        {/* Pillars for Mobile/Tablet - Stacked Below Image */}
        <div className="lg:hidden flex flex-col justify-center items-center gap-3 mt-8 max-w-xl mx-auto">
...
function PillarItem({ pillar, index }) {
  ...
  return (
    <div
      className="group flex items-center gap-3 p-3 rounded-xl border border-primary/10 bg-linear-to-r from-secondary to-white backdrop-blur-sm shadow-lg shadow-primary/40 hover:border-primary/20 transition-all duration-300 cursor-default max-w-xs"
